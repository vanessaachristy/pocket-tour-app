    ...
    <div className="App">
      ...
      <Sidebar menuOpen={menuOpen} setMenuOpen={setMenuOpen}/>
        <Routes>
          ...
          <Route path="/carousel" element={<div><CarouselPage/></div>}></Route>
          <Route path="/edittrip" element={<div><EditTrip/></div>}></Route>
          <Route path="/addrecommendation" element={<div><AddRecommendation/></div>}></Route>
          <Route path="/edittripreccs" element={<div><EditTripReccs/></div>}></Route>
